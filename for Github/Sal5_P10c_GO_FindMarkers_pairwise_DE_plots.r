.libPaths()
#[1] "/work/ABG/carrie/micromamba/envs/seurat_carrie/lib/R/library"
{library(Seurat)
library(Matrix)
library(ggplot2)
library(dplyr)
...
Bcell_DEGs <-c("VIM","THY1","TFRC","STAT2","STAT1","S100A9","RBPJ","PTPRJ","PSMB10","JAK2","ITGB2","ITGAM","FAM49B","CNR2","CIITA","CD79B","CD79A","CD74","CD47","BIRC3","B2M")
...
pdf("/scRNAseq/Sal_5pigs_2026/GO/between_timepoints/GO_DEG_Plots/5pigs_salmonella_STACAS_via_Animal_ScranNorm_Regressed_PCA_d10_Bcells_DEGs_paper_dotPlotCSP.pdf", width=5 ,height=10)
