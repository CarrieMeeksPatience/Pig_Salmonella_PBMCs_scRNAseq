...
D2v0_pos_enrichGO_df$Comparison <- "2DPI vs 0DPI"
...
D2v0_pos_enrichGO_simp_df$Comparison <- "2DPI vs 0DPI"
...
D2v0_neg_enrichGO_df$Comparison <- "2DPI vs 0DPI"
...
if (exists("D2v0_neg_enrichGO_simp")) {
    if (!is.null(D2v0_neg_enrichGO_simp) && nrow(D2v0_neg_enrichGO_simp) > 0) {
        ...
        D2v0_neg_enrichGO_simp_df$Comparison <- "2DPI vs 0DPI"
...
D8v2_pos_enrichGO_df$Comparison <- "8DPI vs 2DPI"
...
D8v2_pos_enrichGO_simp_df$Comparison <- "8DPI vs 2DPI"
...
D8v2_neg_enrichGO_df$Comparison <- "8DPI vs 2DPI"
...
D8v2_neg_enrichGO_simp_df$Comparison <- "8DPI vs 2DPI"
...
#0 DEGs found in 8DPI vs 0DPI for cDCs, so we will not run GO for that comparison
rm()
...
D8v0_pos_enrichGO_df$Comparison <- "8DPI vs 0DPI"
...
D8v0_pos_enrichGO_simp_df$Comparison <- "8DPI vs 0DPI"
...
D8v0_neg_enrichGO_df$Comparison <- "8DPI vs 0DPI"
...
D8v0_neg_enrichGO_simp_df$Comparison <- "8DPI vs 0DPI"
