...
# I want to see the number of DEGs with positive logFC in D2vD0 that are also DEGs with negative logFC in D8vD2

NKcells_overlap <- intersect(unique(NKcells_D2v0_posLogFC$gene),
                             unique(NKcells_D8v2_negLogFC$gene))

length(NKcells_overlap)
write.table(NKcells_overlap, file = "/scRNAseq/Sal_5pigs_2026/DE/between_timepoints/NKcells_D2v0_posLogFC_D8v2_negLogFC_overlap.txt", sep = "\t", quote = FALSE, col.names = FALSE, row.names = FALSE)

NKcells_overlap2 <- intersect(unique(NKcells_D2v0_negLogFC$gene),
                             unique(NKcells_D8v2_posLogFC$gene))

length(NKcells_overlap2)
write.table(NKcells_overlap2, file = "/scRNAseq/Sal_5pigs_2026/DE/between_timepoints/NKcells_D2v0_negLogFC_D8v2_posLogFC_overlap.txt", sep = "\t", quote = FALSE, col.names = FALSE, row.names = FALSE)

# I want to see the number of DEGs with positive logFC in D2vD0 that are also DEGs with negative logFC in D8vD2

CD2neg_GD_Tcells_overlap <- intersect(unique(CD2neg_GD_Tcells_D8v2_posLogFC$gene),
                             unique(CD2neg_GD_Tcells_D8v0_negLogFC$gene))

length(CD2neg_GD_Tcells_overlap)
write.table(CD2neg_GD_Tcells_overlap, file = "/scRNAseq/Sal_5pigs_2026/DE/between_timepoints/CD2neg_GD_Tcells_D8v2_posLogFC_D8v0_negLogFC_overlap.txt", sep = "\t", quote = FALSE, col.names = FALSE, row.names = FALSE)

CD2neg_GD_Tcells2 <- intersect(unique(CD2neg_GD_Tcells_D8v2_negLogFC$gene),
                             unique(CD2neg_GD_Tcells_D8v0_posLogFC$gene))

length(CD2neg_GD_Tcells2)
write.table(CD2neg_GD_Tcells2, file = "/scRNAseq/Sal_5pigs_2026/DE/between_timepoints/CD2neg_GD_Tcells_D8v2_negLogFC_D8v0_posLogFC_overlap.txt", sep = "\t", quote = FALSE, col.names = FALSE, row.names = FALSE)
